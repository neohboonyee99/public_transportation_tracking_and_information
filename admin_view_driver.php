<?php
    ...
    if (isset($_POST['btn_delete_driver'])){
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <button type="button" class="btn btn-link"><a href="admin_add_driver.php">Add New Driver</a></button> 
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th class="border-top-0">Driver Name</th>
                                            <th class="border-top-0">IC Number</th>
                                            <th class="border-top-0">Bus Route Number</th>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Delete Bus Driver</h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <p>Are you sure you want to delete this bus driver?</p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <input type="hidden" name="driver_name" value="'.$value['driver_name'].'"</input>
                                                                <input name="btn_delete_driver" type="submit" class="btn btn-danger" value="Delete"></button>
